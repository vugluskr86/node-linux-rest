...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">69.6% <small>(1264 / 1816)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">62.37% <small>(590 / 946)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">64.94% <small>(176 / 271)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">69.91% <small>(1259 / 1801)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
4417
4418
4419</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >          return a.indexOf(curr) !== -1;</span>
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (a &amp;&amp; typeof a === 'string') {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (gtHelper(a,b)) {</span>
<span class="cstat-no" title="statement not covered" >          return false;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return true;</span>
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (serializedDb.length === 0) <span class="cstat-no" title="statement not covered" >serializedDb = JSON.stringify({});</span>
...
<span class="cstat-no" title="statement not covered" >        this.filteredrows = Object.keys(this.collection.data).map(Number);</span>
      }
&nbsp;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (arrayRef) {
...
<span class="cstat-no" title="statement not covered" >            cd = this.collection.data;</span>
<span class="cstat-no" title="statement not covered" >            cl = cl.length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            for (i = 0; i &lt; cl; i++) {</span>
<span class="cstat-no" title="statement not covered" >              result.push(clone(cd[i], (options.forceCloneMethod || this.collection.cloneMethod)));</span>
            }
          }
...
&nbsp;
      for (i = 0; i &lt; len; i++) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.collection.cloneObjects || options.forceClones) {
<span class="cstat-no" title="statement not covered" >          result.push(clone(data[fr[i]], (options.forceCloneMethod || this.collection.cloneMethod)));</span>
        }
        else {
...
<span class="cstat-no" title="statement not covered" >      var sortFunction = this.sortFunction;</span>
<span class="cstat-no" title="statement not covered" >      var sortCriteria = this.sortCriteria;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.removeFilters();</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (sortFunction !== null){</span>
<span class="cstat-no" title="statement not covered" >        this.applySort(sortFunction);</span>
      }
<span class="cstat-no" title="statement not covered" >      if (sortCriteria !== null) {</span>
<span class="cstat-no" title="statement not covered" >        this.applySortCriteria(sortCriteria);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this.options.persistent) {</span>
<span class="cstat-no" title="statement not covered" >        this.resultsdirty = true;</span>
...
&nbsp;
    ...
    DynamicView.prototype.data = function () {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.filterPipeline.length === 0) {
<span class="cstat-no" title="statement not covered" >        this.applyFind();</span>
      }
&nbsp;
...
&nbsp;
    ...
    DynamicView.prototype.queueRebuildEvent = function () {
      var self = this;
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.rebuildPending) {
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
...
&nbsp;
        changedObjects.forEach(function (object) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if(!object.hasOwnProperty('$loki'))
...
&nbsp;
    Collection.prototype.count = <span class="fstat-no" title="function not covered" >function (query) {</span>
...
&nbsp;
        ...
        obj = self.cloneObjects ? <span class="branch-0 cbranch-no" title="branch not covered" >clone(d, self.cloneMethod) </span>: d;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return clone(this.constraints.unique[field].get(value), this.cloneMethod);</span>
      }
    };
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >        var results = new Resultset(this, query, null);</span>
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Jan 07 2016 06:50:52 GMT+0000 (GMT)</div>
</div>
